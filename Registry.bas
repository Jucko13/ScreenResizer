...
' giving its path.
Sub SetRunAtStartup(ByVal app_name As String, ByVal app_path As String, Optional ByVal run_at_startup As Boolean = True)
    Dim hKey As Long
    ...
    If run_at_startup Then
        ' Create the key.
        key_value = Chr(34) & app_path & "\" & app_name & ".exe" & Chr(34) & " startup" & vbNullChar
